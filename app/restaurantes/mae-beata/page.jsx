...
import styles from './mae-beata.module.css';

export default function MaeBeata() {
  const [imagemAtiva, setImagemAtiva] = useState(0);
  const [abaSelecionada, setAbaSelecionada] = useState('visao-geral');
  const [modalCupom, setModalCupom] = useState(false);

  const restaurante = {
    nome: "Mãe Beata Restaurante",
    rating: '⭐ 4.7 Excelente',
    avaliacoes: 412,
    imagens: [
      "/imagens/imagens.restaurantes/mãe beata/image 6.png",
      "/imagens/imagens.restaurantes/mãe beata/image 7.png",
      "/imagens/imagens.restaurantes/mãe beata/image 8.png",
      "/imagens/imagens.restaurantes/mãe beata/image 9.png",
      "/imagens/imagens.restaurantes/mãe beata/Imagem do WhatsApp de 2025-11-19 à(s) 16.47.10_dcd42667.jpg"
    ],
    descricao: 'É conhecido por sua comida caseira caipira, oferecendo um ambiente acolhedor e familiar. Com uma variedade de pratos típicos da culinária nordestina, o local é ideal para quem busca uma experiência gastronômica autêntica e saborosa.',
    endereco: 'Parque 18 de Maio Na Area Da Feira de Caruaru',
    telefone: '(81) 9 9990-3063',
    cupom: 'MAEBEATA35',
    desconto: '35%',
    validade: '28/02/2026',
    horarios: {
      'segunda-feira': '11:00 - 16:00',
    ...
    <div className={styles.container}>
      <header className={styles.header}>
        ...
        <div className={styles.tituloCentral}>
          <Image 
            src="/imagens/imagens.restaurantes/mãe beata/icon.jpg" 
            alt="Ícone"
            width={32}
            height={32}
