...
import styles from './tio-armenio.module.css';

export default function TioArmenio() {
  ...
  const restaurante = {
    ...
    avaliacoes: 389,
    imagens: [
      "/imagens/imagens.restaurantes/tio armenio/20180220_175131 1.png",
      "/imagens/imagens.restaurantes/tio armenio/image 4.png",
      "/imagens/imagens.restaurantes/tio armenio/image 6.png",
      "/imagens/imagens.restaurantes/tio armenio/image 7.png",
      "/imagens/imagens.restaurantes/tio armenio/image 8.png"
    ],
    descricao: 'O Tio Armênio é um restaurante que serve comida portuguesa com pratos executivos deliciosos. Um ambiente acolhedor que oferece uma experiência gastronômica única com sabores tradicionais.',
    endereco: 'Av. Adjar da Silva Casé, 800 - Indianópolis, Caruaru - PE',
    telefone: '(81) 3721-6666',
    cupom: 'ARMENIO30',
    desconto: '30%',
    validade: '31/12/2025',
    horarios: {
    ...
    <div className={styles.container}>
      <header className={styles.header}>
        ...
        <div className={styles.tituloCentral}>
          <Image 
            src="/imagens/imagens.restaurantes/tio armenio/icon.jpg" 
            alt="Ícone"
            width={32}
            height={32}
