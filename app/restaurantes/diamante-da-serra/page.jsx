...
import styles from './diamante-da-serra.module.css';

export default function DiamanteDaSerra() {
  ...
  const restaurante = {
    ...
    avaliacoes: 287,
    imagens: [
      "/imagens/imagens.restaurantes/diamante da serra/image 1.png",
      "/imagens/imagens.restaurantes/diamante da serra/image 6.png",
      "/imagens/imagens.restaurantes/diamante da serra/image 7.png",
      "/imagens/imagens.restaurantes/diamante da serra/image 8.png",
      "/imagens/imagens.restaurantes/diamante da serra/image 9.png"
    ],
    descricao: 'O Restaurante Diamante da Serra, localizado em Caruaru, é conhecido por sua comida típica e ambiente rural encantador. Com um cardápio variado e um espaço amplo, o local oferece uma experiência gastronômica agradável e deliciosa.',
    ...
    <div className={styles.container}>
      <header className={styles.header}>
        ...
        <div className={styles.tituloCentral}>
          <Image 
            src="/imagens/imagens.restaurantes/diamante da serra/icon.jpg" 
            alt="Ícone"
            width={32}
            height={32}
