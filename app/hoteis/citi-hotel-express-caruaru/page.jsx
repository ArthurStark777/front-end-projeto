...
import styles from './citi-hotel-express-caruaru.module.css';

export default function CitiHotelExpress() {
  ...
  const hotel = {
    ...
    imagens: [
      '/imagens/imagens.hoteis/citi hotel express caruaru/Rectangle 32.png',
      '/imagens/imagens.hoteis/citi hotel express caruaru/Rectangle 33.png',
      '/imagens/imagens.hoteis/citi hotel express caruaru/Rectangle 35.png'
    ],
    descricao: 'Esta propriedade oferece WiFi e estacionamento, ambos gratuitos, bem como uma conveniente opção de serviço de quarto. Localizado em área nobre de Caruaru, oferece conforto e praticidade para sua estadia.',
    endereco: 'Av. Campina Grande, 241 Caruaru',
    telefone: '+55(81)37245880',
    checkIn: '14:00',
    checkOut: '12:00',
    comodidades: [
      'WiFi gratuito',
