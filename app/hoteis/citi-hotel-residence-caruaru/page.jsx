...
import styles from './citi-hotel-residence-caruaru.module.css';

export default function CitiHotelResidence() {
  ...
  const hotel = {
    ...
    imagens: [
      '/imagens/imagens.hoteis/citi hotel residence caruaru/citi hotel.png',
      '/imagens/imagens.hoteis/citi hotel residence caruaru/Rectangle 42.png',
      '/imagens/imagens.hoteis/citi hotel residence caruaru/Rectangle 43.png',
      '/imagens/imagens.hoteis/citi hotel residence caruaru/Rectangle 44.png',
      '/imagens/imagens.hoteis/citi hotel residence caruaru/Rectangle 45.png'
    ],
    descricao: 'Oferece acomodações que incluem uma piscina ao ar livre e uma academia moderna e dispõe de WiFi e estacionamento gratuito. Perfeito para estadias prolongadas com toda infraestrutura necessária.',
    endereco: 'Av. Procurador Pedro Jorge, 92 Caruaru',
    telefone: '+55(81)37215883',
    checkIn: '14:00',
    checkOut: '12:00',
    comodidades: [
      'WiFi gratuito',
